...
public class SpringsView: UIView {
  public var duration: TimeInterval = 1
  
  public var
  beachBallSpringDamping: CGFloat = 0,
  beachBallSpringInitialVelocity: CGFloat = 0,
  drinkSpringDamping: CGFloat = 0,
  drinkSpringInitialVelocity: CGFloat = 0,
  iceCreamSpringDamping: CGFloat = 0,
  iceCreamSpringInitialVelocity: CGFloat = 0
