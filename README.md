...
Четкой грани, в каком случае использовать протокол как тип, а в каком, как ограничение на тип - нет. Более того — иногда требуется использовать протокол в обоих сценариях. Можно попытаться выделить случаи использования:
